class NewsData {
  ...
  static List<NewsData> recentNewsData = [
    ...
    NewsData(
        "Inverse vaccine may reverse autoimmune diseases like MS, new study says",
        "By Corrie Pelc",
        "During this study, researchers developed a new type of vaccine called an inverse vaccine.According to Dr. Jeffrey Hubbell, a professor in tissue engineering at the Pritzker School of Molecular Engineering at the University of Chicago and the lead author of this study, a regular vaccine induces immune cell activation to create cells that can kill infected cells and generate antibodies that can bind to and neutralize viruses that would infect them.An inverse vaccine can instead unwind such immunity,” Hubbell explained to Medical News Today.In an autoimmune disease, we are seeking inverse vaccines that can deactivate immune cells that have erroneously been licensed to attack one’s own cells and even generate cells that can act so as to further tamp down immunity, called regulatory T cellsTrusted Source,” he said.Through the use of the inverse vaccine, scientists were able to do this without shutting down the body’s entire immune system. ",
        "Sep 17,2023",
        "https://cepi.net/wp-content/uploads/2020/04/IVI-Inovio-KNIH_website.jpg"),
  ];
}
